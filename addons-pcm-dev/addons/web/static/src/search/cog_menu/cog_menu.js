...
export class CogMenu extends ActionMenus {
    ...
    /**
     * Check if the cog menu should be hidden for the current model
      @returns {boolean}
     */
    shouldHideCogMenu() {   
        ...
        return hiddenModels.includes(currentModel);
    }

    /**
     * Get current model name from various sources
     * @returns {string}
     */
    getCurrentModelName() {
    ...
    debugCurrentModel() {
        ...
        console.log('Env searchModel:', this.env.searchModel);
