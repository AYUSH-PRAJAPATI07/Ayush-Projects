	...
	this.enqueueFile = function(file){
        ...
        this.createProgress = function (filename,filepath,filesize) {
            ...
            if(s.showFileCounter)
                fileNameStr = obj.fileCounter + s.fileCounterStyle + filepath;
            ...
            if(s.showDelete)
            {
                ...
                pd.del.click(function () {
                    ...
                    var arr = [filename];
                    if(s.deleteCallback) s.deleteCallback.call(this, arr, pd, obj);
                    obj.selectedFiles -= 1;
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.done = $("<div style='color: #2db300; pointer-events: none; cursor: default;'>" + "100%" + "</div>").appendTo(this.statusbar).hide();
